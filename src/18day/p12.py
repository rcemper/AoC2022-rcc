...
FILE = "C:/GitHub/set2/18/input.txt"
...
def main():
    ...
    with open(FILE, "r", encoding="utf-8") as f:
        cubes = [tuple(int(x) for x in l.strip().split(",")) for l in f.readlines()]

        print(f"part 1 = {part_one(cubes)}")
        print(f"part 2 = {part_two(cubes)}")
