const fs = require('fs');
const dir = "c:\\GitHub\\set1\\15\\" ;
const input = fs.readFileSync(dir+'data.txt', 'utf8').trimEnd(),
  targetY = 2000000,
  maxCoord = 4000000;
...
function solve1(input) {
  ...
  console.log('part 1 = '+(Object.values(targetRow).reduce((acc, n) => acc + n)).toString());
}
solve1(input);
      ...
      for (let i2 = 0; i2 < 4; i2++) {
        for (let j2 = 0; j2 < 4; j2++) {
          ...
          if (
            ...
            console.log('part 2 = '+(4000000 * xi + yi).toString());
            break outer;
          }
        }
      }
